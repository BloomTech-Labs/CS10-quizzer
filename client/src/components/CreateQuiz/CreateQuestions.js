          ...
          <div key={index}>
            ...
            <fieldset className='question_fieldset'>
              <div>
                ...
                <input className='question_choices' name={index} placeholder='Choice 1' onChange={this.props.choiceChange} required type='text' />
              </div>
              <div>
                <input checked={choices[index][1][1]} name={index} id='1' onChange={this.props.check} required type='radio' />
                <input className='question_choices' name={index} placeholder='Choice 2' onChange={this.props.choiceChange} required type='text' />
              </div>
              <div>
                <input checked={choices[index][2][1]} disabled={choices[index][2][2]} id='2' name={index} onChange={this.props.check} type='radio' />
                <input className='question_choices' disabled={choices[index][2][2]} placeholder='Choice 3' onChange={this.props.choiceChange} required type='text' />
              ...
              <div>
                ...
                <input className='question_choices' disabled={choices[index][3][2]} placeholder='Choice 4' onChange={this.props.choiceChange} required type='text' />
